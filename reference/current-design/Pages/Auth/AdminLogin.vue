...
<div class="al-page">
  ...
  <div class="al-center">
    ...
    <div class="al-logo-area">
      <img src="/images/sdb-logo.png" alt="SDB Wallet" class="al-logo-img" />
    </div>
    ...
    <p class="al-copy">© 2026 SDB Wallet — Syria Digital Wallet</p>
  </div>
</div>
</template>
...
.al-c2{width:350px;height:350px;background:radial-gradient(circle,#10481A,transparent 70%);bottom:-10%;left:-5%}
...
.al-logo-img{height:64px;object-fit:contain}
.al-mark{font-size:36px;font-weight:900;color:#10481A;letter-spacing:-2px;display:inline-flex;align-items:center;gap:4px}
...
.al-lock{width:48px;height:48px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#10481A,#9FE870);color:#fff;border-radius:14px;margin:0 auto 16px}
.al-title{font-size:22px;font-weight:900;color:#10481A;text-align:center;letter-spacing:-.03em}
.al-sub{font-size:13px;color:rgba(22,51,0,.35);text-align:center;margin-top:4px;margin-bottom:28px}

.al-alert{padding:12px;background:rgba(45,106,0,.06);border:1px solid rgba(45,106,0,.1);color:#10481A;font-size:13px;font-weight:600;border-radius:12px;margin-bottom:16px;text-align:center}
...
.al-input{width:100%;padding:14px 16px;background:#f8faf6;border:1.5px solid rgba(22,51,0,.08);border-radius:12px;font-size:14px;color:#10481A;outline:none;transition:all .2s;font-family:inherit}
...
.al-check input{width:16px;height:16px;accent-color:#10481A;border-radius:4px}

.al-btn{width:100%;padding:15px;background:linear-gradient(135deg,#10481A,#3d8a00);color:#fff;border:none;border-radius:14px;font-size:15px;font-weight:800;cursor:pointer;transition:all .2s;font-family:inherit;display:flex;align-items:center;justify-content:center;gap:8px;margin-top:4px}
