...
.step-n{width:48px;height:48px;background:linear-gradient(135deg,#9FE870,#10481A);color:#fff;font-size:20px;font-weight:900;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 16px}
.step-t{font-size:16px;font-weight:800;color:#10481A;margin-bottom:8px}
...
.reward-t{font-size:15px;font-weight:800;color:#10481A;margin-bottom:6px}
...
.ref-url{font-size:14px;color:#10481A;font-weight:600;word-break:break-all}
.ref-copy{padding:12px 24px;background:linear-gradient(135deg,#10481A,#9FE870);color:#fff;border:none;border-radius:12px;font-size:14px;font-weight:800;cursor:pointer;font-family:inherit;transition:all .2s;white-space:nowrap}.ref-copy:hover{transform:translateY(-1px);box-shadow:0 4px 12px rgba(159,232,112,.2)}
