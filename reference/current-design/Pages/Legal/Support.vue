...
const t = computed(() => isAr.value ? {
  ...
  addrTitle:'العنوان',addr:'SDB Wallet\nEurope',
  ...
  addrTitle:'Address',addr:'SDB Wallet\nEurope',
...
.p-hero{padding:150px 0 60px;background:linear-gradient(135deg,#10481A,#1a3d00,#0f2600);color:#fff;position:relative;overflow:hidden}
...
.sp-ic{font-size:32px;display:block;margin-bottom:12px}.sp-t{font-size:16px;font-weight:800;color:#10481A;margin-bottom:6px}.sp-d{font-size:13px;color:#666;line-height:1.7;margin-bottom:16px}
.sp-btn{display:inline-block;padding:10px 20px;background:#10481A;color:#fff;border:none;border-radius:10px;font-size:13px;font-weight:700;text-decoration:none;cursor:pointer;font-family:inherit;transition:all .2s}.sp-btn:hover{background:#0d3a14}
...
.tp-ic{font-size:24px;display:block;margin-bottom:8px}.tp-t{font-size:14px;font-weight:800;color:#10481A;margin-bottom:4px}.tp-d{font-size:12px;color:#666;line-height:1.7}
...
.info-h{font-size:16px;font-weight:800;color:#10481A;margin-bottom:16px}
...
/* Chat Widget */
.chat-fab{position:fixed;bottom:24px;right:24px;width:60px;height:60px;border-radius:50%;background:#9FE870;color:#10481A;border:none;font-size:28px;cursor:pointer;box-shadow:0 8px 24px rgba(159,232,112,.4);z-index:100;transition:all .2s}.chat-fab:hover{transform:scale(1.1)}
...
.chat-header{background:linear-gradient(135deg,#10481A,#1a3d00,#0f2600);color:#fff;padding:16px 20px;display:flex;justify-content:space-between;align-items:center}
...
.chat-user .chat-bubble{background:#10481A;color:#fff;border-bottom-right-radius:4px}
...
.chat-send{padding:10px 18px;background:#10481A;color:#fff;border:none;border-radius:10px;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit}
