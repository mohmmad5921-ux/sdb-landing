...
const t = computed(() => isAr.value ? {
  ...
  types:[
    ...
    {ic:'🌐',t:'SWIFT (دولي)',d:'تحويلات دولية لأي خدمة مالية بالعالم عبر شبكة SWIFT. آمنة وموثوقة.',time:'1-3 أيام عمل',fee:'0.5%'},
  ...
  faqs:[
    {q:'كم تستغرق التحويلات الدولية؟',a:'SEPA (أوروبا) يوصل بثوانٍ. SWIFT الدولي يوصل خلال 1-3 أيام عمل حسب بلد وخدمة المستلم.'},
  ...
  title:'Transfers — SDB Wallet',tag:'Send to Family',
